...
var _loadMoreJs = require("./loadMore.js");
var _hospitalIconPng = require("url:./img/Hospital-icon.png");
var _hospitalIconPngDefault = parcelHelpers.interopDefault(_hospitalIconPng);
var _phoneIconBluePng = require("url:./img/Phone-icon-blue.png");
var _phoneIconBluePngDefault = parcelHelpers.interopDefault(_phoneIconBluePng);
var _linkIconPng = require("url:./img/Link-icon.png");
var _linkIconPngDefault = parcelHelpers.interopDefault(_linkIconPng);
...
async function consultantDetails() {
    try {
        showConsultantDetails = await (0, _helpersJs.getJSON)((0, _utilsJs.BASE_URL));
    } catch (err) {
        console.log(err);
    }
}
...
function pageButtons(pages) {
    ...
    wrapper.innerHTML = ``;
    for(let page = 1; page <= pages; page++)wrapper.innerHTML += `<button value=${page} class="page page-link">${page}</button>`;
...
function resultsQuery() {
    ...
    if (end_index > showConsultantDetails.length) end_index = showConsultantDetails.length;
    ...
    <div class="consultant__info--summary">
        <div class="consultant__info--details">
          ...
          <div class="consultant__info--addressWrapper">
            ...
            <span><img class="consultant__info--icon" src=${0, _hospitalIconPngDefault.default} alt="Hospital"></span>Based at: ${info.Hospital} • 9 Miles</p>
            <div class="consultant__info--contact">
              <a class="consultant__info--contactPhone" href="tel:${info.PhoneNo}"><span><img src=${0, _phoneIconBluePngDefault.default} alt="Phone Number" class="consultant__info--icon" ></span>${info.PhoneNo}</a>
              <a class="consultant__info--contactWebsite" href="#"><span><img src=${0, _linkIconPngDefault.default} alt="Website address" class="consultant__info--icon" ></span>Go to hospital website</a>
              <a class="consultant__info--contactDirections" href=#><span><img src=${0, _linkIconPngDefault.default} alt="Get Directions" class="consultant__info--icon" ></span>Get directions</a>
            </div>
          </div>
        </div>
...
_loadMoreJs.loadMore();

},{"./loadMore.js":"9Tpkk","url:./img/Hospital-icon.png":"eh1f1","url:./img/Phone-icon-blue.png":"C3Zib","url:./img/Link-icon.png":"lEig1","./utils.js":"en4he","./helpers.js":"ecN5O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Tpkk":[function(require,module,exports) {
//load more consultant data function
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadMore", ()=>loadMore);
function loadMore() {
...
},{}],"eh1f1":[function(require,module,exports) {
module.exports = require("3854b57dc4582361").getBundleURL("lORN7") + "Hospital-icon.6d8e17a2.png" + "?" + Date.now();

},{"3854b57dc4582361":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"C3Zib":[function(require,module,exports) {
module.exports = require("8c4c2ac72fea50e7").getBundleURL("lORN7") + "Phone-icon-blue.20150602.png" + "?" + Date.now();

},{"8c4c2ac72fea50e7":"lgJ39"}],"lEig1":[function(require,module,exports) {
module.exports = require("b7f4fee7fa7592aa").getBundleURL("lORN7") + "Link-icon.9c010902.png" + "?" + Date.now();

},{"b7f4fee7fa7592aa":"lgJ39"}],"en4he":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BASE_URL", ()=>BASE_URL);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
const BASE_URL = "https://gc-interview.azurewebsites.net/api/consultantlisting";
...
const getJSON = async function(url) {
    try {
        ...
        const response = await Promise.race([
            fetch(url),
            timeout((0, _utilsJs.TIMEOUT_SEC))
        ]);
...
},{"./utils.js":"en4he","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["47Zjz","8ZNvh"], "8ZNvh", "parcelRequireb8f7")
